...
make -j8 O=out ARCH=arm64 CC=$(pwd)/toolchains/clang/bin/clang CROSS_COMPILE=$(pwd)/toolchains/gcc/bin/aarch64-linux-android- CLANG_TRIPLE=aarch64-linux-gnu- arch/arm64/configs/garden_defconfig
